...
2. **Nghiên cứu & Tìm kiếm thông tin**
   - Tìm repo code/tài liệu liên quan dựa trên từ khóa.
   - Gửi link tham khảo và giới thiệu sơ lược về dự án/tài liệu đó.
   - Đề xuất giải pháp dựa trên thông tin tìm được.

3. **Lên kế hoạch & Thiết kế**
   - Xác định cấu trúc thư mục (module hóa).
   - Chia nhỏ task thành các bước logic.
   - Trình bày ngữ cảnh và mục tiêu cụ thể.

4. **Triển khai từng bước (Step-by-step)**
   - KHÔNG đưa hết code 1 lần.
   - Đưa code từng phần (module).
   - Giải thích chi tiết: Tại sao dùng hàm này? Logic hoạt động ra sao?
   - Hướng dẫn người dùng code tay (không copy-paste mù quáng).
...
6. **Hoàn thiện & Push Git**
   - Sau khi xong 1 module lớn -> Test -> Tự động Push.
